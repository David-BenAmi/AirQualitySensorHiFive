...
class I2CGPS {
  public:
    ...
    boolean begin(SlowSoftWire &wirePort, u_char address);
  ...
  private:
    ...
    SlowSoftWire *_i2cPort; //The generic connection to user's chosen I2C hardware
    uint8_t _i2caddr;
